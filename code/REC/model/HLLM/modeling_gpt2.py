...
class GPT2ForCausalLM(GPT2LMHeadModel):
    """
    Compatibility wrapper for GPT2 to mimic LlamaForCausalLM-style interface.
    Inherits directly from HuggingFace's GPT2LMHeadModel.
    """
    ...
    def from_pretrained(cls, model_name_or_path, *args, **kwargs):
        """
        Load pretrained model, just like HuggingFace's standard method.
        """
    ...
    def forward(
        ...
        """
        Standard forward method outputting `CausalLMOutputWithPast` to match Llama-style.
        """
